...
@section('content')
    ...
    <div style="position: fixed; top: 20px; right: 20px; z-index: 1000;">
        <a href="{{route('pantshirts.print', $pantShirt->id)}}" target="_blank" class="btn btn-primary btn-lg shadow-lg" id="printBtn">
...
<body>
    <div class="maindiv rounded ml-5 mr-5" style="margin-top: %;padding-top: 1%;padding-bottom:5%;margin-bottom: 40%;">
        ...
        <div class="cust mt-5 py-3 px-5" style="margin-left: 2%">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Booking Time:</b> {{ $pantshirt->created_at ? $pantshirt->created_at->setTimezone('Asia/Karachi')->format('h:i A') : 'N/A' }}</span></div>
                </div>
                <div class="col-md-6">
