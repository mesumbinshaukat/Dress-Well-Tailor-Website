...
@section('content')
    ...
    <div style="position: fixed; top: 20px; right: 20px; z-index: 1000;">
        <a href="{{route('suits.print', $suit->id)}}" target="_blank" class="btn btn-primary btn-lg shadow-lg" id="printBtn">
    ...
    <div class="maindiv rounded ml-5 mr-5" style="margin-top: 3%;padding-top: 1%;padding-bottom: 5%;margin-bottom: 40%;">
        ...
        <div class="cust mt-5 py-3 px-5" style="margin-left: 2%">
            ...
            <div class="row ">
                ...
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Booking Date:</b> {{ $suit->created_at ? $suit->created_at->format('d-m-Y') : 'N/A' }}</span></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Booking Time:</b> {{ $suit->created_at ? $suit->created_at->setTimezone('Asia/Karachi')->format('h:i A') : 'N/A' }}</span></div>
                </div>
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Trial Date:</b> {{ $suit->trail_date ?? 'Not Set' }}</span></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Remaining Amount: </b>{{ $suit->total_amount - $suit->advance }}</span> </div>
                </div>
            </div>
