...
@section('content')
    ...
    <div style="position: fixed; top: 20px; right: 20px; z-index: 1000;">
        <a href="{{route('coats.print', $coat->id)}}" target="_blank" class="btn btn-primary btn-lg shadow-lg" id="printBtn">
...
<body>
    <div class="maindiv rounded ml-5 mr-5" style="margin-top: 2%;padding-top: 1%;padding-bottom: 9%;margin-bottom: 10%;">
        ...
        <div class="cust mt-5 py-3 px-5" style="margin-left: 2%">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div> <span class="fw-bolder text-dark"><b>Booking Time:</b><span class="pl-1"></span>{{ $coat->created_at ? $coat->created_at->setTimezone('Asia/Karachi')->format('h:i A') : 'N/A' }}</span></div>
                </div>
                <div class="col-md-6">
            ...
            <div class="back3 mx-3">
                <table class="mt-1 table table-bordered py-4 px-5 my-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td class="text-dark h5"><b>Collar Size:</b><span class="pl-4"></span> {{$coat->collar_size}}</span></td>
                            <td></td>
                            <td class="text-dark h5"><b>Shirt Fitting:</b><span class="pl-4"></span> {{$coat->shirt_fitting}}</span></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td class="text-dark h5"><b>Shirt Fitting Size:</b><span class="pl-4"></span> {{$coat->shirt_fitting_size}}</span></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
